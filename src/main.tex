...
% Example of paraphrased sentences
    ...
    The model was trained on the training set, and then evaluated on the test set.
    The test set was not used in the training of the model, and was used to evaluate the models performance on unseen data.
    ...
    To emable me to find the best model, I tested the model on the test set after every epoch.
    ...
    I found that the model performed best with a batch size of 32, and a learning rate of 2e-5 at 20 epochs.
...
All models were trained for 30 epochs, similar to the hyperparameter search. The best accuracy was taken after testing on every epoch and the results are displayed below. \par
%
%\begin{table}[]
%\centering
%\begin{tabular}{@{}llll@{}}
...
%\multicolumn{1}{|l|}{Bert-base-uncased} & \multicolumn{1}{l|}{0.733}  & \multicolumn{1}{l|}{0.7332} & \multicolumn{1}{l|}{20} \\ \midrule
%\multicolumn{1}{|l|}{DistilBert}        & \multicolumn{1}{l|}{0.7189} & \multicolumn{1}{l|}{0.7192} & \multicolumn{1}{l|}{25} \\ \midrule
%\multicolumn{1}{|l|}{Albert}            & \multicolumn{1}{l|}{0.7061} & \multicolumn{1}{l|}{0.7075} & \multicolumn{1}{l|}{29} \\ \midrule
